...
include_once('products_in_cart.php');
    ...
    class Cart{
      ...
      public function getAllProducts($id){
         ...
         $prodCart = new ProductsInCard();

         return $prodCart->getCartById($id);
      }
     ...
     /*  public function getProductInCartAndProductId($card_Id, $product_id){

        $productsCart = new ProductsInCard();

        return $productsCart->getQuantityProductInCart($card_Id, $product_id);
